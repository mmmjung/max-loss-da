...
def get_basic_arg_parser():
    ...
    parser.add_argument('--vocab-inverse')
    
    parser.add_argument('--synonym-mode')
    
    parser.add_argument('--synonym', action='store_true')
    parser.add_argument('--synonym-single', action='store_true')
    
    parser.add_argument('--synonym-path')
    
    parser.add_argument('--probability', '-p', type=float, default=1.0,
                        help='Probability for synonym replacement')
